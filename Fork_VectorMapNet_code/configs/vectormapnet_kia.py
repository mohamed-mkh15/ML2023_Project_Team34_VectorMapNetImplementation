...
eval_cfg = dict(
    ...
    evaluation_cfg=dict(
        result_path='./',
        dataroot='/mnt/datasets/kia/',
        # will be overwirte in code
        ann_file='/mnt/datasets/kia/kia_map_trainval_infos_train.pkl',
        num_class=num_class,
...
data = dict(
    ...
    train=dict(
        type='KiaDataset',
        data_root='./datasets/kia',
        # ann_file='./datasets/nuScenes/nuscenes_map_infos_train.pkl',
        ann_file='./datasets/kia/kia_map_infos_train.pkl',
    ...
    val=dict(
        type='KiaDataset',
        data_root='./datasets/kia',
        ann_file='./datasets/kia/kia_map_infos_val.pkl',
        modality=input_modality,
        roi_size=roi_size,
        cat2id=class2label,
        pipeline=train_pipeline,
